...
const (
	...
	AgentTrafficProtocolTKProtocolCQL     AgentTrafficProtocolT = 4
	AgentTrafficProtocolTKProtocolPGSQL   AgentTrafficProtocolT = 5
	AgentTrafficProtocolTKProtocolDNS     AgentTrafficProtocolT = 6
	AgentTrafficProtocolTKProtocolNATS    AgentTrafficProtocolT = 7
	AgentTrafficProtocolTKProtocolMux     AgentTrafficProtocolT = 8
	AgentTrafficProtocolTKProtocolAMQP    AgentTrafficProtocolT = 9
	AgentTrafficProtocolTKNumProtocols    AgentTrafficProtocolT = 10
)
